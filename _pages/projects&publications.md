...
| ![geometry](geometry.png){:height="300px" width="300px"}|In <strong>the Knowldge Landscape and Strategic Decision Making of New Ventures</strong>, we apply the NK model to simulate the strategic search of new ventures on a rugged landscape. We hope to explore how knowledge expertise and competition shape the positioning decisions of new ventures in a highly uncertain market.<br> *Cao, L., Zhong, Q. Data Mining.* | 